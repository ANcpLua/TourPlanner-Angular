...
public class TourRepositoryTests
{
    ...
    public async Task CreateTourAsync_WithValidTour_ReturnsSavedTour()
    {
        ...
        var result = await _repository.CreateTourAsync(tour, TestConstants.TestUserId);
    ...
    public void CreateTourAsync_WithInvalidTour_ThrowsDbUpdateException()
    {
        ...
        Assert.That(async () => await _repository.CreateTourAsync(tour, TestConstants.TestUserId), Throws.InstanceOf<DbUpdateException>());
    }

    [Test]
    public void GetAllTours_WithExistingTours_ReturnsOnlyOwnedTours()
    {
        var tours = TourTestData.SampleTourPersistenceList();
        _context.ToursPersistence.AddRange(tours);
        _context.SaveChanges();

        var result = _repository.GetAllTours(TestConstants.TestUserId).ToList();
    ...
    public void GetTourById_WithExistingId_ReturnsTour()
    {
        ...
        var result = _repository.GetTourById(tour.Id, TestConstants.TestUserId);
    ...
    public void GetTourById_WithNonExistingId_ReturnsNull()
    {
        ...
        var result = _repository.GetTourById(nonExistingId, TestConstants.TestUserId);
    ...
    public async Task UpdateTourAsync_WithExistingTour_ReturnsUpdatedTour()
    {
        ...
        var result = await _repository.UpdateTourAsync(tour, TestConstants.TestUserId);
    ...
    public void UpdateTourAsync_WithNonExistingTour_ThrowsInvalidOperationException()
    {
        ...
        Assert.That(async () => await _repository.UpdateTourAsync(tour, TestConstants.TestUserId),
    ...
    public async Task DeleteTourAsync_WithExistingId_RemovesTourFromDatabase()
    {
        ...
        await _repository.DeleteTourAsync(tour.Id, TestConstants.TestUserId);
    ...
    public async Task DeleteTourAsync_WithNonExistingId_DoesNotRemoveAnyTourFromDatabase()
    {
        ...
        await _repository.DeleteTourAsync(Guid.NewGuid(), TestConstants.TestUserId);
    ...
    public async Task SearchToursAsync_WithMatchingSearchText_ReturnsMatchingTours()
    {
        ...
        var result = await _repository.SearchToursAsync("Sample", TestConstants.TestUserId).ToListAsync();
    ...
    public async Task SearchToursAsync_WithNonMatchingSearchText_ReturnsEmptyList()
    {
        ...
        var result = _repository.SearchToursAsync("NonExistingTour", TestConstants.TestUserId);
    ...
    public void SearchToursAsync_WithNullOrEmptySearchText_ReturnsAllOwnedTours()
    {
        ...
        var result = _repository.SearchToursAsync(null!, TestConstants.TestUserId);
