...
describe('TourMapComponent', () => {
  ...
  it('should draw polyline from route geometry when provided', async () => {
    const fixture = TestBed.createComponent(TourMapComponent);
    fixture.componentRef.setInput('fromLat', 48.2082);
    fixture.componentRef.setInput('fromLng', 16.3738);
    fixture.componentRef.setInput('toLat', 52.52);
    fixture.componentRef.setInput('toLng', 13.405);
    fixture.componentRef.setInput('routeGeometry', [
      [16.3738, 48.2082],
      [14.9456, 50.1234],
      [13.405, 52.52],
    ]);
    ...
    expect(leaflet.latLng).toHaveBeenCalledWith(48.2082, 16.3738);
    expect(leaflet.latLng).toHaveBeenCalledWith(50.1234, 14.9456);
    expect(leaflet.latLng).toHaveBeenCalledWith(52.52, 13.405);
    expect(leaflet.polyline).toHaveBeenCalledOnce();
  });
