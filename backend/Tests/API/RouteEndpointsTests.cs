...
public class RouteEndpointsTests
{
    ...
    [Test]
    public async Task ResolveRoute_ValidRequest_ReturnsDistanceDurationAndGeometry()
    {
        var geometry = new double[][] { [16.3738, 48.2082], [13.405, 52.52] };
        _mockRouteService
            ...
            .ReturnsAsync(new ResolvedRoute(523400.0, 18000.0, geometry));
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(result.Value?.Geometry, Is.EqualTo(geometry));
        }
    }
